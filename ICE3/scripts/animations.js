...
$(".red-box").fadeOut(3000, function() {
    // Call the hide function to accompany the fadeout timer
    ($(this)).hide();
});
...
// for the red box, delay by 1000ms, then fade to 50% opacity with 1000 ms timeout, delay by 1000ms, fade to 100% opacity with 1000ms timeout, 
// delay  1000ms, then fade out (use chaining)
